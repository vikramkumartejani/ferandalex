        ...
        <div className="relative w-full lg:h-screen h-full flex items-center justify-end z-[4]">
          ...
          >
            <img
              ...
              alt="contact-img"
            />
            <div className="absolute inset-0 flex w-fit md:mx-0 mx-auto flex-col items-start justify-center xlg:top-[47.5%] lg:top-[47%] md:top-[40%] sm:top-[33%] xs:top-[0%] top-[10%] gap-6 md:ps-4">
              <Link
