  ...
  return (
    <div className="bg-[#F26A45]">
      <div className="overflow-x-hidden">
        <h2 className="text-white md:pt-[160px] pt-[100px] lg:ps-[120px] lg:pe-0 md:px-[81px] sm:px-[25px] px-[20px] text-[#F26A45] md:text-[64px] text-[43px] font-[700] md:leading-[86.24px] leading-[50px] tracking-[1%] font-clashdisplay-regular">
          CORPORATE
        </h2>
