...
const OurVision = () => {
  return (
    <div className="overflow-x-hidden">
      <h2 className="text-white pt-[160px] lg:px-[120px] md:px-[80px] sm:px-[30px] text-[#F26A45] md:text-[64px] text-[43px] font-[700] md:leading-[86.24px] leading-[50px] tracking-[1%] font-clashdisplay-regular">
        Viziunea noastra
      </h2>
